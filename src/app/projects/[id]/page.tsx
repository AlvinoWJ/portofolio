...
import { motion, AnimatePresence, Variants } from "framer-motion"; // Import Variants untuk fix error TS
...
export default function ProjectDetailPage() {
  ...
  return (
    <main className="min-h-screen bg-background py-12 px-6 md:px-12 lg:px-24">
      ...
      <AnimatePresence>
        {selectedIndex !== null && project.galleryImages && (
          <motion.div
            ...
            onClick={(e) => {
              // Tutup hanya jika klik background hitam
      ...
      {/* Bagian Bawah: Project Results (Galeri) */}
